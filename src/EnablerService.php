 ...
 */
 ...
 class EnablerService{
     ...
     * @param Node $node
     * @return bool
     * Whether of not the node is enabled for the RSVP functionality.
     */
    public function isEnabled(Node &$node){
        ...
        try{
            ...
            \Drupal::messenger()->addError(
                t('Unable to determine RSVP settings. Try again.')
            );
    ...
    public function setEnabled(Node $node){
        try{
            ...
            \Drupal::messenger()->addError(
                t('Unable to save RSVP settings. Try again.')
            );
        }
    }
